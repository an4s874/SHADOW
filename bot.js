...
const devs = ['478192028279111690'];
const db = require('quick.db');
const premium = ['478192028279111690']
...
client.login(process.env.NTc5MDA4MDg5NzE0MzI3NTUy.XQpmKQ.v2rEB-wwnO7a7BWSx2r3hYk8Qvc)
